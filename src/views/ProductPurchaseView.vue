      ...
      <div class="container d-lg-flex">
        <div class="box-1 bg-light user">
            ...
            <div class="box-inner-1 pb-3 mb-3 ">
                ...
                <p class="dis info my-3">Bicicleta de acero. Esta bicicleta de acero es ideal para viajar y 
                  disfrutar de aventuras al aire libre. Con un diseño resistente y duradero, te brinda estabilidad y confianza en cada trayecto.
                </p>
