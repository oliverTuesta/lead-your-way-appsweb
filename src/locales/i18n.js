...
const i18n = createI18n({
  ...
  messages: {
    es: {
      ...
      option1: 'Ruta',
      'option1-content':
        'La bicicleta de ruta se utiliza para describir bicicletas construidas para viajar a gran velocidad en carreteras pavimentadas. Sus características están pensadas para llevarte tan lejos y tan rápido como tus piernas lo permitan. Tienen un diseño con ángulos de asiento y frontales muy verticales, un eje pedalier alto y muy poca curvatura de la horquilla.',
      option2: 'Montaña',
      'option2-content':
        'Son bicicletas que, o bien carecen de suspensión o tienen un sistema de amortiguación delantera en la horquilla. Normalmente el recorrido de esta suspensión es de menos de 120mm, ya que están pensadas para rodar a toda velocidad por pistas y tramos sin asfaltar sin grandes desniveles ni obstáculos pronunciados.',
      option3: 'Ciudad',
      'option3-content':
      ...
      'get-started-content':
        'Crear una cuenta en Lead Your Way es muy fácil y te permitirá acceder a una amplia variedad de opciones de bicicletas. Además, al ser parte de nuestra comunidad, tendrás acceso a descuentos exclusivos, promociones especiales y podrás estar al tanto de las últimas novedades en el mundo de las bicicletas.',
      login: 'Iniciar sesión',
      register: 'Registrarse',
      NotFound: 'Error 404',
      NotFoundMessage: 'Lo sentimos, la página que estás buscando no existe.',
      NotFoundButton: 'Volver al inicio',
      'loginpage-welcome': 'Bienvenido',
      'loginpage-message': '¿No tienes una cuenta?',
      'loginpage-register': 'Crea una ahora',
      'loginpage-name': 'Nombre',
      'loginpage-email': 'Correo electrónico',
      'loginpage-password': 'Contraseña',
      'loginpage-remember': 'Recuérdame',
    ...
    en: {
      ...
      option1: 'Road',
      'option1-content':
        'The road bike is used to describe bicycles built to travel at high speed on paved roads. Its features are designed to take you as far and as fast as your legs will allow. They have a design with very vertical seat and front angles, a high bottom bracket and very little fork curvature.',
      option2: 'Mountain',
      'option2-content':
        'They are bicycles that either lack suspension or have a front suspension system in the fork. Normally the travel of this suspension is less than 120mm, since they are designed to roll at full speed on tracks and unpaved sections without large slopes or pronounced obstacles.',
      option3: 'City',
      'option3-content':
        'An urban bicycle is characterized by having simple but resistant components to any puncture. Its maintenance is simpler and therefore cheaper. Compared to a mountain bike they are usually heavier and do not require suspensions for city trips.',
      ...
      login: 'Login',
      register: 'Sign up',
      'loginpage-welcome': 'Welcome',
      'loginpage-message': "Don't have an account?",
      'loginpage-register': 'Create one now',
      'loginpage-name': 'Name',
    ...
    fr: {
      ...
      option1: 'Route',
      'option1-content':
        'Le vélo de route est utilisé pour décrire les vélos construits pour voyager à grande vitesse sur des routes pavées. Ses caractéristiques sont conçues pour vous emmener aussi loin et aussi vite que vos jambes le permettront. Ils ont une conception avec des angles de siège et de face très verticaux, un boîtier de pédalier haut et très peu de courbure de fourche.',
      option2: 'Montagne',
      'option2-content':
        'Ce sont des vélos qui manquent de suspension ou qui ont un système de suspension avant dans la fourche. Normalement, le déplacement de cette suspension est inférieur à 120 mm, car ils sont conçus pour rouler à pleine vitesse sur des pistes et des sections non pavées sans grandes pentes ni obstacles prononcés.',
      option3: 'Ville',
      'option3-content':
        'Un vélo urbain se caractérise par des composants simples mais résistants à toute crevaison. Son entretien est plus simple et donc moins cher. Par rapport à un VTT, ils sont généralement plus lourds et ne nécessitent pas de suspensions pour les trajets en ville.',
      ...
      login: 'Connexion',
      register: 'S’inscrire',
      'loginpage-welcome': 'Bienvenue',
      'loginpage-message': "Vous n'avez pas de compte?",
      'loginpage-register': 'Créez-en un maintenant',
      'loginpage-name': 'Nom',
      'loginpage-email': 'Email',
      'loginpage-password': 'Mot de passe',
      'loginpage-remember': 'Souviens-toi de moi',
    ...
    ja: {
      ...
      option1: '道路',
      'option1-content':
        'ロードバイクは、舗装された道路で高速で移動するために作られた自転車を表すために使用されます。その特徴は、あなたの足が許す限り遠く、速くあなたを連れて行くように設計されています。彼らは非常に垂直なシートとフロントアングル、高いボトムブラケット、そして非常に少ないフォーク曲率を持つデザインを持っています。',
      option2: '山',
      'option2-content':
        'それらはサスペンションを欠いているか、フォークに前部サスペンションシステムを備えています。通常、このサスペンションの移動は120mm未満であり、大きな傾斜や顕著な障害物のないトラックや未舗装の区間でフルスピードで走行するように設計されています。',
      option3: '市',
      'option3-content':
        '都市の自転車は、どんなパンクにも耐えられるシンプルで丈夫なコンポーネントを持っていることを特徴としています。そのメンテナンスはよりシンプルで、したがってより安価です。マウンテンバイクと比較して、通常より重く、都市の旅行にはサスペンションは必要ありません。',
      'meet-our-team': '私たちのチームに会いましょう',
      'get-started-slogan': '私たちのコミュニティに参加してください',
      'get-started-content':
        'Lead Your Wayでアカウントを作成するのはとても簡単で、様々な自転車のオプションにアクセスできます。また、私たちのコミュニティの一員になることで、独占的な割引、特別なプロモーションにアクセスでき、自転車の世界の最新ニュースを知ることができます。',
      login: 'ログイン',
      register: '登録',
      'loginpage-welcome': 'ようこそ',
      'loginpage-message': 'アカウントをお持ちではありませんか？',
      'loginpage-register': '今すぐ作成',
      'loginpage-name': '名前',
      'loginpage-email': 'Eメール',
      'loginpage-password': 'パスワード',
      'loginpage-remember': '私を覚えてますか',
